...
\begin{align}
\eqmathbox[LHS_dci_elem][r]{\frac{\partial c_{i} }{\partial T }} &= 0 & \eqmakebox[cond_dci_elem][r]{,} \label{e:dci_elem_dt} \\
\eqmathbox[LHS_dci_elem][r]{\frac{\partial c_{i} }{\partial {n_j} }} &= 0 & \eqmakebox[cond_dci_elem][r]{,} \label{e:dci_elem_dnj} \\
\end{align}
and:
\begin{subequations}
 \label{e:dci_elem_de}
 \begin{align}
  \eqmathbox[LHS_dci_elem][r]{\frac{\partial c_{i} }{\partial V }} &= 0 & \eqmakebox[cond_dci_elem][r]{\dconp} \\
  \eqmathbox[LHS_dci_elem][r]{\frac{\partial c_{i} }{\partial P }} &= 0 & \eqmakebox[cond_dci_elem][r]{\dconv}
 \end{align}
\end{subequations}
...
\begin{align}
 \eqmathbox[LHS_dci][r]{\frac{\partial [X]_i }{\partial T }} &= \eqmathbox[RHS_dci][l]{-\frac{[C] \alpha_{\ns,i}}{T}} & \eqmakebox[cond_dci_thd][r]{,} \label{e:dci_thd_dt} \\
 \eqmathbox[LHS_dci][r]{\frac{\partial [X]_i }{\partial n_{j}}} &= \eqmathbox[RHS_dci][l]{\frac{1}{V} \left(- \alpha_{\ns,i} + \alpha_{j,i}\right)} & \eqmakebox[cond_dci_thd][r]{,} \label{e:dci_thd_dnj}
\end{align}
and:
\begin{subequations}
 \label{e:dci_thd_de}
 \begin{align}
  \eqmathbox[LHS_dci][r]{\frac{\partial [X]_i }{\partial V }} &= \eqmathbox[RHS_dci][l]{\frac{1}{V} \left([C] \alpha_{\ns,i} - [X]_{i}\right)} & \eqmakebox[cond_dci_thd][r]{\dconp}\\
  \eqmathbox[LHS_dci][r]{\frac{\partial [X]_i }{\partial P }} &= \eqmathbox[RHS_dci][l]{\frac{\alpha_{\ns,i}}{T \Ru}} & \eqmakebox[cond_dci_thd][r]{\dconv}
 \end{align}
\end{subequations}

If $\alpha_{j,i} = 1$ for all species $j$,~\cref{e:dci_thd_dt,e:dci_thd_dnj,e:dci_thd_de} may be simplified to:
\begin{align}
 \eqmathbox[lhs_dci_thd_unity][r]{\frac{\partial c_{i} }{\partial T }} &= \eqmathbox[rhs_dci_thd_unity][l]{- \frac{[C]}{T}}& \eqmakebox[cond_dci_thd_unity][r]{,} \label{e:dci_thd_unity_dt} \\
 \eqmathbox[lhs_dci_thd_unity][r]{\frac{\partial c_{i} }{\partial n_{j} }} &= \eqmathbox[rhs_dci_thd_unity][l]{0}& \eqmakebox[cond_dci_thd_unity][r]{,}
\end{align}
and:
\begin{subequations}
 \label{e:dci_thd_unity_de}
 \begin{align}
  \eqmathbox[lhs_dci_thd_unity][r]{\frac{\partial c_{i} }{\partial V }} &= \eqmathbox[rhs_dci_thd_unity][l]{0} & \eqmakebox[cond_dci_thd_unity][r]{\dconp} \\
  \eqmathbox[lhs_dci_thd_unity][r]{\frac{\partial c_{i} }{\partial P }} &= \eqmathbox[rhs_dci_thd_unity][l]{\frac{1}{T \Ru}}&\eqmakebox[cond_dci_thd_unity][r]{\dconv}
 \end{align}
\end{subequations}
 
If the third-body is the $m$th species,~\cref{e:dci_thd_dt,e:dci_thd_dnj,e:dci_thd_de} become:
\begin{align}
 \eqmathbox[lhs_dci_thd_spec][r]{\frac{\partial c_{i} }{\partial T }} &= \eqmathbox[rhs_dci_thd_spec][l]{-\frac{\delta_{\ns m}}{T} [C]}&\eqmakebox[cond_dci_thd_spec][r]{,} \label{e:dci_thd_spec_dt} \\
 \eqmathbox[lhs_dci_thd_spec][r]{\frac{\partial c_{i} }{\partial n_j }} &= \eqmathbox[rhs_dci_thd_spec][l]{\frac{1}{V} \left(- \delta_{\ns m} + \delta_{j m}\right)}&\eqmakebox[cond_dci_thd_spec][r]{,} \label{e:dci_thd_spec_dnj} \\
\end{align}
and:
\begin{subequations}
\label{e:dci_thd_spec_de}
\begin{align}
\eqmathbox[lhs_dci_thd_spec][r]{\frac{\partial c_{i} }{\partial V }} &= \eqmathbox[rhs_dci_thd_spec][l]{\frac{\delta_{\ns m}}{V} \left([C] - [C]_{\ns}\right) + \frac{[C]_{m}}{V} \left(\delta_{\ns m} - 1\right)} & \eqmakebox[cond_dci_thd_spec][r]{\dconp} \\
\eqmathbox[lhs_dci_thd_spec][r]{\frac{\partial c_{i} }{\partial P }} &= \eqmathbox[rhs_dci_thd_spec][l]{\frac{\delta_{\ns m}}{T \Ru}} & \eqmakebox[cond_dci_thd_spec][r]{\dconv}
\end{align}
\end{subequations}
...
\begin{align}
 \eqmathbox[lhs_dci_fall][r]{\frac{\partial c_{i} }{\partial T }} &= \eqmathbox[rhs_dci_fall][l]{\frac{1}{P_{r, i} + 1} \left(P_{r, i} \frac{\partial F_{i} }{\partial T } + \frac{\partial P_{r, i} }{\partial T } \left(F_{i} - c_{i}\right)\right)} & \eqmakebox[cond_dci_fall][r]{,} \label{e:dci_fall_dt}\\
 \eqmathbox[lhs_dci_fall][r]{\frac{\partial c_{i} }{\partial n_j}} &= \eqmathbox[rhs_dci_fall][l]{\frac{1}{P_{r, i} + 1} \left(P_{r, i} \frac{\partial F_{i} }{\partial n[j] } + \frac{\partial P_{r, i} }{\partial n_j } \left(F_{i} - c_{i}\right)\right)} & \eqmakebox[cond_dci_fall][r]{,} \label{e:dci_fall_dnj}
\end{align}
and with respect to the thermodynamic parameter:
\begin{subequations}
 \label{e:dci_fall_de}
 \begin{align}
  \eqmathbox[lhs_dci_fall][r]{\frac{\partial c_i }{\partial V }} &= \eqmathbox[rhs_dci_fall][l]{\frac{1}{P_{r, i} + 1} \left(P_{r, i} \frac{\partial F_{i} }{\partial V } + \frac{\partial P_{r, i} }{\partial V } \left(F_{i} - c_{i}\right)\right)} & \eqmakebox[cond_dci_fall][r]{\dconp} \\
  \eqmathbox[lhs_dci_fall][r]{\frac{\partial c_i }{\partial P }} &= \eqmathbox[rhs_dci_fall][l]{\frac{1}{P_{r, i} + 1} \left(P_{r, i} \frac{\partial F_{i} }{\partial P } + \frac{\partial P_{r, i} }{\partial P } \left(F_{i} - c_{i}\right)\right)} & \eqmakebox[cond_dci_fall][r]{\dconv}
 \end{align}
\end{subequations}
...
\begin{align}
 \label{e:dci_chem_dt}
 \eqmathbox[lhs_dci_chem][r]{\frac{\partial c_i }{\partial T }} &= \eqmathbox[rhs_dci_chem][l]{\frac{1}{P_{r, i} + 1} \left(\frac{\partial F_{i} }{\partial T } - \frac{\partial P_{r, i} }{\partial T } c_{i}\right)} & \eqmakebox[cond_dci_chem][r]{,} \\
 \label{e:dci_chem_dnj}
 \eqmathbox[lhs_dci_chem][r]{\frac{\partial c_i }{\partial n_j }} &= \eqmathbox[rhs_dci_chem][l]{\frac{1}{P_{r, i} + 1} \left(\frac{\partial F_{i} }{\partial n_j } - \frac{\partial P_{r, i} }{\partial n_j } c_{i}\right)} & \eqmakebox[cond_dci_chem][r]{,}
\end{align}
and:
\begin{subequations}
 \label{e:dci_chem_de}
 \begin{align}
  \eqmathbox[lhs_dci_chem][r]{\frac{\partial c_i }{\partial V }} &= \eqmathbox[rhs_dci_chem][l]{\frac{1}{P_{r, i} + 1} \left(\frac{\partial F_{i} }{\partial V } - \frac{\partial P_{r, i} }{\partial V } c_{i}\right)} & \eqmakebox[cond_dci_chem][r]{\dconp} \\
  \eqmathbox[lhs_dci_chem][r]{\frac{\partial c_i }{\partial P }} &= \eqmathbox[rhs_dci_chem][l]{\frac{1}{P_{r, i} + 1} \left(\frac{\partial F_{i} }{\partial P } - \frac{\partial P_{r, i} }{\partial P } c_{i}\right)} & \eqmakebox[cond_dci_chem][r]{\dconv}
 \end{align}
\end{subequations}
...
\begin{align}
 \eqmathbox[lhs_dpr_mix][r]{\frac{\partial P_{r, i} }{\partial T }} &= \eqmathbox[rhs_dpr_mix][l]{\frac{P_{r, i}}{T} \left(\beta_{0} - \beta_{\infty} + \frac{E_{a, 0}}{T \Ru} - \frac{E_{a, \infty}}{T \Ru}\right) - \frac{[C] k_{0, i} \alpha_{\ns,i}}{T k_{\infty, i}}} & \eqmakebox[cond_dpr_mix][r]{,} \label{e:dpr_mix_dt} \\
 \eqmathbox[lhs_dpr_mix][r]{\frac{\partial P_{r, i} }{\partial n_j }} &= \eqmathbox[rhs_dpr_mix][l]{\frac{k_{0, i} \left(- \alpha_{\ns,i} + \alpha_{j,i}\right)}{k_{\infty, i} V}} & \eqmakebox[cond_dpr_mix][r]{,} \label{e:dpr_mix_dnj}
\end{align}
and:
\begin{subequations}
 \label{e:dpr_mix_de}
 \begin{align}
  \eqmathbox[lhs_dpr_mix][r]{\frac{\partial P_{r, i} }{\partial V }} &= \eqmathbox[rhs_dpr_mix][l]{- \frac{P_{r, i}}{V} + \frac{[C] k_{0, i} \alpha_{\ns,i}}{V k_{\infty, i}}} & \eqmakebox[cond_dpr_mix][r]{\dconp} \\
  \eqmathbox[lhs_dpr_mix][r]{\frac{\partial P_{r, i} }{\partial P }} &= \eqmathbox[rhs_dpr_mix][l]{\frac{k_{0, i} \alpha_{\ns,i}}{T k_{\infty, i} \Ru}} & \eqmakebox[cond_dpr_mix][r]{\dconv}
 \end{align}
\end{subequations}

For a third-body concentration where all $\alpha_{k,i}=1$:
\begin{align}
 \eqmathbox[lhs_dpr_unity][r]{\frac{\partial P_{r, i} }{\partial T }} &= \eqmathbox[rhs_dpr_unity][l]{\frac{P_{r, i}}{T} \left(\beta_{0} - \beta_{\infty} - 1 + \frac{E_{a, 0}}{T \Ru} - \frac{E_{a, \infty}}{T \Ru}\right)} & \eqmakebox[cond_dpr_unity][r]{,} \label{e:dpr_unity_dt} \\
 \eqmathbox[lhs_dpr_unity][r]{\frac{\partial P_{r, i} }{\partial n_j }} &= \eqmathbox[rhs_dpr_unity][l]{0} & \eqmakebox[cond_dpr_unity][r]{,} \label{e:dpr_unity_dnj}
\end{align}
and:
\begin{subequations}
 \label{e:dpr_unity_de}
 \begin{align}
  \eqmathbox[lhs_dpr_unity][r]{\frac{\partial P_{r, i} }{\partial V }} &= \eqmathbox[rhs_dpr_unity][l]{0} & \eqmakebox[cond_dpr_unity][r]{\dconp}\\
  \eqmathbox[lhs_dpr_unity][r]{\frac{\partial P_{r, i} }{\partial P }} &= \eqmathbox[rhs_dpr_unity][l]{\frac{k_{0, i}}{k_{\infty, i}} \frac{1}{\Ru T}} & \eqmakebox[cond_dpr_unity][r]{\dconv}
 \end{align}
\end{subequations}

Finally, for species $m$ as the third-body:
\begin{align}
 \eqmathbox[lhs_dpr_spec][r]{\frac{\partial P_{r, i} }{\partial T }} &= \eqmathbox[rhs_dpr_spec][l]{\frac{P_{r, i}}{T} \left(\beta_{0} - \beta_{\infty} + \frac{E_{a, 0}}{T \Ru} - \frac{E_{a, \infty}}{T \Ru}\right) - \frac{[C] k_{0, i} \delta_{\ns m}}{T k_{\infty, i}}} & \eqmakebox[cond_dpr_spec][r]{,} \label{e:dpr_spec_dt} \\
 \eqmathbox[lhs_dpr_spec][r]{\frac{\partial P_{r, i} }{\partial n_j }} &= \eqmathbox[rhs_dpr_spec][l]{\frac{k_{0, i}}{V k_{\infty, i}} \left(- \delta_{\ns m} + \delta_{j m}\right)} & \eqmakebox[cond_dpr_spec][r]{,} \label{e:dpr_spec_dnj}
\end{align}
and:
\begin{subequations}
 \label{e:dpr_spec_de}
 \begin{align}
  \eqmathbox[lhs_dpr_spec][r]{\frac{\partial P_{r, i} }{\partial V }} &= \eqmathbox[rhs_dpr_unity][l]{- \frac{P_{r, i}}{V} + \frac{[C] k_{0, i} \delta_{\ns m}}{V k_{\infty, i}}} & \eqmakebox[cond_dpr_spec][r]{\dconp}\\
  \eqmathbox[lhs_dpr_spec][r]{\frac{\partial P_{r, i} }{\partial P }} &= \eqmathbox[rhs_dpr_unity][l]{\frac{k_{0, i} \delta_{\ns m}}{T k_{\infty, i} \Ru}} & \eqmakebox[cond_dpr_spec][r]{\dconv}
 \end{align}
\end{subequations}

\Crefrange{e:dpr_mix_dt}{e:dpr_spec_de} may be recast in a more generalized form using temporary variables $\Theta_{\partial P_{r, i}, \ldots}$ and $\bar{\theta}_{\partial P_{r, i}, \ldots}$ to replace terms in the derivative:
\begin{align}
 \eqmathbox[lhs_dpr_gen][r]{\frac{\partial P_{r, i} }{\partial T } } &= \eqmathbox[rhs_dpr_gen][l]{P_{r, i} \Theta_{P_{r,i}, \partial T} + \bar{\theta}_{P_{r, i}, \partial T}} & \eqmakebox[cond_dpr_gen][r]{,} \label{e:dpr_dt} \\
 \eqmathbox[lhs_dpr_gen][r]{\frac{\partial P_{r, i} }{\partial n_j}} &= \eqmathbox[rhs_dpr_gen][l]{\frac{\bar{\theta}_{P_{r, i}, \partial n_j}}{V k_{\infty, i}} k_{0, i}} & \eqmakebox[cond_dpr_gen][r]{,} \label{e:dpr_dnj}
\end{align}
and:
\begin{subequations}
 \label{e:dpr_de}
 \begin{align}
  \eqmathbox[lhs_dpr_gen][r]{\frac{\partial P_{r, i} }{\partial V}} &= \eqmathbox[rhs_dpr_gen][l]{P_{r, i} \Theta_{P_{r,i}, \partial V} + \bar{\theta}_{P_{r, i}, \partial V}} & \eqmakebox[cond_dpr_gen][r]{\dconp} \\
  \eqmathbox[lhs_dpr_gen][r]{\frac{\partial P_{r, i} }{\partial P}} &= \eqmathbox[rhs_dpr_gen][l]{\bar{\theta}_{P_{r, i}, \partial P}} & \eqmakebox[cond_dpr_gen][r]{\dconv}
 \end{align}
\end{subequations}
with:
\begin{align}
 ...
 \begin{dcases}
  ...
  \frac{1}{T} \left(\beta_{0} - \beta_{\infty} - 1 + \frac{E_{a, 0}}{T \Ru} - \frac{E_{a, \infty}}{T \Ru}\right) & \text{if all $\alpha_{k,i}$ = 1,} \\
  \frac{1}{T} \left(\beta_{0} - \beta_{\infty} + \frac{E_{a, 0}}{T \Ru} - \frac{E_{a, \infty}}{T \Ru}\right) & \text{for species $m$}
 \end{dcases} \\
 \bar{\theta}_{P_{r, i}, \partial T} &=
 \begin{dcases}
  \eqmathbox[theta_pr_bar_dt][l]{- \frac{[C] k_{0, i} \alpha_{\ns,i}}{T k_{\infty, i}}} & \text{if mix,} \\
  \eqmathbox[theta_pr_bar_dt][c]{0} & \text{if all $\alpha_{k,i}$ = 1,} \\
  \eqmathbox[theta_pr_bar_dt][l]{- \frac{[C] k_{0, i} \delta_{\ns m}}{T k_{\infty, i}}} & \text{for species $m$}
 \end{dcases} \\
 \bar{\theta}_{P_{r, i}, \partial n_j} &=
 \begin{dcases}
  \eqmathbox[theta_pr_bar_dnj][l]{- \alpha_{\ns,i} + \alpha_{j,i}} & \text{if mix,} \\
  \eqmathbox[theta_pr_bar_dnj][c]{0} & \text{if all $\alpha_{k,i}$ = 1,} \\
  \eqmathbox[theta_pr_bar_dnj][l]{- \delta_{\ns m} + \delta_{j m}} & \text{for species $m$}
 \end{dcases} \\
 \Theta_{P_{r,i}, \partial V} &=
 \begin{dcases}
  \eqmathbox[Theta_pr_bar_dv][l]{- \frac{1}{V}} & \text{if mix,} \\
  \eqmathbox[Theta_pr_bar_dv][c]{0} & \text{if all $\alpha_{k,i}$ = 1,} \\
  \eqmathbox[Theta_pr_bar_dv][l]{- \frac{1}{V}} & \text{for species $m$}
 \end{dcases} \\
 \bar{\theta}_{P_{r, i}, \partial V} &=
 \begin{dcases}
  \eqmathbox[theta_pr_bar_dv][l]{\frac{[C] k_{0, i} \alpha_{\ns,i}}{V k_{\infty, i}}} & \text{if mix,} \\
  \eqmathbox[theta_pr_bar_dv][c]{0} & \text{if all $\alpha_{k,i}$ = 1,} \\
  \eqmathbox[theta_pr_bar_dv][l]{\frac{[C] k_{0, i} \delta_{\ns m}}{V k_{\infty, i}}} & \text{for species $m$}
 \end{dcases} \\
 \bar{\theta}_{P_{r, i}, \partial P} &=
 \begin{dcases}
  \eqmathbox[theta_pr_bar_dp][l]{\frac{k_{0, i} \alpha_{\ns,i}}{T k_{\infty, i} \Ru}} & \text{if mix,} \\
  \eqmathbox[theta_pr_bar_dp][l]{\frac{k_{0, i}}{T k_{\infty, i} \Ru}} & \text{if all $\alpha_{k,i}$ = 1,} \\
  \eqmathbox[theta_pr_bar_dp][l]{\frac{k_{0, i} \delta_{\ns m}}{T k_{\infty, i} \Ru}} & \text{for species $m$}
 \end{dcases} \\
\end{align}
