...
The \texttt{TChem} software package~\cite{Safta:2011vn} was one of the first packages developed providing this functionality, but has several limitations including: incompatibilities with modern reaction types (i.e., pressure dependent Arrhenius and Chebyshev reactions), and lack of thread-safety to enable parallel execution~\cite{Curtis2017:tchem}. 
