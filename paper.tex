...
Yonkee and Sutherland~\cite{Yonkee2016} implemented \delete{GPU-}accelerated evaluations of thermodynamic parameters, multicomponent transport properties, and species production rates \delete{on an Intel Xeon E5-2680} \add{on both the CPU} and \delete{a Tesla K20} GPU, \revise{achieving speedups over serial evaluation between \SIrange{8}{13}{$\times$} on a 16 core CPU, and \SIrange{20}{40}{$\times$} on the GPU}.
