...
In this article we
\begin{itemize}
 \item Derive and verify a new Jacobian formulation that greatly increases sparsity\delete{: \texttt{pyJac v2}};
 ...
 \item \add{Investigate the performance of SIMD\slash SIMT-vectorization for a wide range of chemical kinetic models, and compare with the previous version of our analytical chemical kinetic Jacobian code~\cite{Niemeyer:2016aa}; and finally}
...
\begin{itemize}
 \item Deriving and verifying a new Jacobian formulation \delete{for \texttt{pyJac}} that greatly increases sparsity;
