...
In this article we
\begin{itemize}
 \item Derive and \add{reproducibly} verify a new Jacobian formulation for \texttt{pyJac} that greatly increases sparsity: \texttt{pyJac v2};
...
\end{itemize}
To our knowledge, this is the first open-source, verified effort that vectorizes the evaluation of chemical-kinetic source terms and Jacobian matrices for any chemical model on a wide selection of platforms.
