...
\begin{tabular}{@{}l l l l l@{}}
\toprule
Model & NVIDIA Driver Version & CUDA Cores & Identifier \\
\midrule
Tesla C2075 & 384.81 & \num{448} & \texttt{C2075} \\
Tesla K40m & 375.26 & \num{2880} & \texttt{K40m} \\
\bottomrule
\end{tabular}
\label{t:gpus}
\caption{The GPU configurations used in this study.  NVIDIA's OpenCL runtime is provided with the graphic driver, rather than any specific version of CUDA.}
\end{table}
