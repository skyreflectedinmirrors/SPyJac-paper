...
Vectorized data-orderings specifically formulated for shallow\slash deep SIMD\slash SIMT vectorizations were proposed, and were shown to yield larger speedups in a shallow-vectorized execution as compared to standard data-ordering layouts in a parallel OpenMP code.
...
Analytical Jacobian evaluation was significantly faster than a first-order finite-difference based approach on all platforms.
