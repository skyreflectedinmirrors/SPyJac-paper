...
For such solvers, there is no need for the exact form of the Jacobian and the so-called ``appropriate'' form is preferable.
...
Table~\cref{T:jac_sparsity} shows the density of the exact and approximate Jacobians for all mechanisms tested in this work.
