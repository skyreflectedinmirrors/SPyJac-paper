...
Here we present \texttt{pyJac}, a code generation platform for single-instruction, multiple-data (SIMD) and single-instruction, multiple thread (SIMT) vectorized constant-pressure\slash volume thermochemical source-term and sparse\slash dense chemical kinetic Jacobian evaluation.
