...
\end{align}
In our experience, the LAPACK error norm is often dominated by the accuracy of the larger elements in the Jacobian, while the filtered error norm (although significantly more stringent) is useful for identifying errors in both large and small Jacobian entries.
