...
\add{Hansen and Sutherland~\cite{HANSEN2018257} explored the choice of thermochemical state-vectors and their resulting effect on consistency and errors in conserved properties such as mass and energy, and the effect on implicit\slash linearly-implicit integration techniques, as well as analysis techniques such as chemical explosive mode analysis~\cite{lu_yoo_chen_law_2010}.}
...
\subsection{\add{Future extensions to this work and practical notes on OpenCL usage}}
