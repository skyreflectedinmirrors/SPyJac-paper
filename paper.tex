...
\revise{Significant speedups in shallow SIMD-vectorized execution over a parallel OpenMP code were demonstrated for evaluations of the chemical kinetic source-term and sparse\slash dense Jacobian: up to \SI{4.09}{$\times$}, \SI{9.44}{$\times$} and \SI{4.23}{$\times$}, respectively, on an \avx/-capable CPU.}
