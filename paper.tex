...
In Table~\ref{T:source_error}, the results of this code's source-rate evaluations are compared to Cantera~\cite{Cantera} on the library of PaSR conditions (\cref{t:models}).
...
This is due in large part to the superior performance of the shallow-vectorized OpenCL code, coupled with the relatively small amounts of work associated with source-rate evaluation.
...
The analytical Jacobian on the \gpunew/ and \gpuold/ shows large (and very similar) speedups, increasing with chemical model size, in the range of \SIrange{4.66}{17.43}{$\times$}.
