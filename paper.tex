...
Bisetti~\cite{Bisetti:2012jw} developed an isothermal, isobaric analytical Jacobian code-generation utility; although this set of assumptions (particularly, the choice of an isothermal system) are incompatible with many combustion simulations, a significant increase in Jacobian sparsity was exhibited.
